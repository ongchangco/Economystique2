...
"color: white;")
        ...
        self.cntFileList = QtWidgets.QFrame(self.centralwidget)
        self.cntFileList.setGeometry(QtCore.QRect(480, 160, 291, 271))
        self.cntFileList.setStyleSheet("background-color: white;\n"
"")
        self.cntFileList.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.cntFileList.setFrameShadow(QtWidgets.QFrame.Raised)
        self.cntFileList.setObjectName("cntFileList")
        ...
        self.btnOpenFile_2 = QtWidgets.QPushButton(self.centralwidget)
        self.btnOpenFile_2.setGeometry(QtCore.QRect(640, 440, 121, 31))
        self.btnOpenFile_2.setAutoFillBackground(False)
        self.btnOpenFile_2.setObjectName("btnOpenFile_2")
        self.btnOpenFile_3 = QtWidgets.QPushButton(self.centralwidget)
        self.btnOpenFile_3.setGeometry(QtCore.QRect(550, 490, 141, 51))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, account):
        ...
        self.btnOpenFile_2.setText(_translate("account", "❌ Delete File"))
        self.btnOpenFile_3.setText(_translate("account", "Add File"))
